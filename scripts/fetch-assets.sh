#!/usr/bin/env bash
# Refresh assets/ from an adjacent ../xquest/ original distribution.
# The repo already bundles the game data needed to build and play - only
# run this if you want to replace it from a different/newer distribution.
set -euo pipefail
