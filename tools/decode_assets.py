...
#         (whole-image planar: plane0's bmwidth*height bytes, then plane1's,
#          then plane2's, then plane3's - not interleaved per row)
# ---------------------------------------------------------------------------
    ...
    for row in range(height):
        for plane in range(4):
            for col in range(bmwidth):
                byte_idx = plane * (bmwidth * height) + row * bmwidth + col
